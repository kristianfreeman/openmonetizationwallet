      ...
      <div className="py-6">
        ...
        <div className="mt-5 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
          <div className="bg-white overflow-hidden shadow rounded-lg">
            ...
            <div className="bg-gray-50 px-4 py-4 sm:px-6">
              <div className="text-sm leading-5">
                <Link to="/admin/logs" className="font-medium text-indigo-600 hover:text-indigo-500 transition ease-in-out duration-150">
                  View all
                </Link>
              </div>
            </div>
          ...
          <div className="bg-white overflow-hidden shadow rounded-lg">
            ...
            <div className="bg-gray-50 px-4 py-4 sm:px-6">
              <div className="text-sm leading-5">
                <Link to="/admin/users" className="font-medium text-indigo-600 hover:text-indigo-500 transition ease-in-out duration-150">
                  View all
                </Link>
              </div>
            </div>
